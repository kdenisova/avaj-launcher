...
public class Simulator {
    ...
    public void Simulation() throws NumberFormatException {
        ...
        for (String item: scenario) {
            if (i == 0) {
                ...
                flyable = factory.newAircraft(result[0], result[1], Integer.parseInt(result[2]), Integer.parseInt(result[3]), Integer.parseInt(result[4]));
